    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto">
                ...
                <form class="p-5 border mb-5" method="POST" action="<?php url('product/update'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" required class="form-control" value="<?php echo $row['quantity']; ?>" name="quantity" id="qty">
                    </div>
